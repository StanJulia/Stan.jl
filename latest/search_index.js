...
{
    "location": "VERSIONS.html#Version-3.0.1-1",
    "page": "Versions",
    "title": "Version 3.0.1",
    "category": "section",
    "text": "Added ODE examples from DiffEqBayes.jl"
},

{
    "location": "VERSIONS.html#Version-3.0.0-1",
    "page": "Versions",
    "title": "Version 3.0.0",
    "category": "section",
    "text": "Julia 0.7- compatible"
},

{
    "location": "VERSIONS.html#Version-2.0.2-1",
    "page": "Versions",
    "title": "Version 2.0.2",
    "category": "section",
    "text": "Julia 0.6 only\nAdded ODE examples from DiffEqBayes.jl"
},

{
    "location": "VERSIONS.html#Version-2.0.1-1",
    "page": "Versions",
    "title": "Version 2.0.1",
    "category": "section",
...

{
    ...
    "title": "Version 2.0.0",
    "category": "section",
    "text": "Compatible with Julia 0.6.\nAdded optional keyward argument useMamba to stanmodel().\nAll test now set useMamba=false and do not depend on either Mamba or Gadfly.\nTamas Papp figured out how to install CmdStan on Travis! This allows proper testing of Stan.jl on various unix/linux versions. Currently Travis tests Julia 0.5 and 0.6 on linux. The master branch typically tests on nightlies and osx as well.\nComplete documentation (initial version, will no doubt take additional work).\nStreamline R file creation for observed data and initialization values.\nImprove error catching."
},
...
{
    "location": "index.html#Stan.read_stanfit-Tuple{Stanmodel}",
    "page": "Stan.jl documentation",
