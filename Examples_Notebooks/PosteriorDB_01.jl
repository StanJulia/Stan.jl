...
posterior_pdb = posterior(pdb, "M0_data-M0_model")
...
# ╔═╡ 32831937-e82c-41b3-83bd-0f25a62b6540
DataFrame(post.posterior)
...
# ╔═╡ 48e0b38c-e72b-439d-aac4-dad55f8c05bc
data["y"] = data["y"]'

# ╔═╡ b201d58c-2145-4f02-aedf-c56bb71aa527
model_1=model(posterior_pdb)
...
manifest_format = "2.0"
project_hash = "67fbb3a1844a1c0ebfac7799670a254337429f45"
