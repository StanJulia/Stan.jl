...
md" #### Setup BRIDGESTAN_HOME!!!!"

# ╔═╡ 58fe54b3-bd37-457e-aff9-e8debda735c5
BRIDGESTAN_HOME = "/Users/rob/Projects/StanSupport/bridgestan"

# ╔═╡ 634c1ab3-3f4c-446e-8472-cf010ba53e7f
include(joinpath(BRIDGESTAN_HOME, "julia", "src", "BridgeStan.jl"))

# ╔═╡ a0114cae-0e22-494d-acd3-ead068f1ce95
p1=joinpath(BRIDGESTAN_HOME, "test_models/bernoulli/bernoulli.stan")

# ╔═╡ 5b344a46-a50e-4bac-bd31-3f5afde81d73
p2=joinpath(BRIDGESTAN_HOME, "test_models/bernoulli/bernoulli.data.json")

# ╔═╡ b43c1dbc-8d64-45ff-afbc-c8fabba22f8f
BS = BridgeStan

# ╔═╡ 169c92e3-09b3-4b46-958a-da2de2ddb1cd
BS.set_bridgestan_path!(BRIDGESTAN_HOME)
...
let
	...
	(log_probability=lp, gradient=grad)
end
...
manifest_format = "2.0"
project_hash = "6c7c360af392db20c1a461155480277d6d58b081"
