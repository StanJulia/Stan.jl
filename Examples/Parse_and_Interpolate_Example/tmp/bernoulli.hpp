...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/Users/rob/.julia/dev/CmdStan/examples/Parse_and_Interpolate_Example/tmp/bernoulli.stan");
    reader.add_event(31, 29, "end", "/Users/rob/.julia/dev/CmdStan/examples/Parse_and_Interpolate_Example/tmp/bernoulli.stan");
    return reader;
}
