...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/Users/rob/.julia/v0.6/Stan/Examples/OtherExamples/DiffEqBayes/LotkaVolterra/tmp/parameter_estimation_model.stan");
    reader.add_event(31, 31, "end", "/Users/rob/.julia/v0.6/Stan/Examples/OtherExamples/DiffEqBayes/LotkaVolterra/tmp/parameter_estimation_model.stan");
    return reader;
}
...
sho(const T0__& t,
    ...
    try {
        {
            validate_non_negative_index("du", "2", 2);
            vector<fun_scalar_t__> du(2);
            stan::math::initialize(du, std::numeric_limits<double>::quiet_NaN());
            stan::math::fill(du,DUMMY_VAR__);


            current_statement_begin__ = 4;
            stan::math::assign(get_base1_lhs(du,1,"du",1), ((get_base1(theta,1,"theta",1) * get_base1(u,1,"u",1)) - ((get_base1(u,1,"u",1) * 1.0) * get_base1(u,2,"u",1))));
            current_statement_begin__ = 4;
            stan::math::assign(get_base1_lhs(du,2,"du",1), ((get_base1(u,2,"u",1) * -(3.0)) + ((get_base1(u,1,"u",1) * 1.0) * get_base1(u,2,"u",1))));
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        validate_non_negative_index("u", "2", 2);
        context__.validate_dims("data initialization", "u", "double", context__.to_vec(T,2));
        validate_non_negative_index("u", "T", T);
        validate_non_negative_index("u", "2", 2);
        u = std::vector<std::vector<double> >(T,std::vector<double>(2,double(0)));
        vals_r__ = context__.vals_r("u");
        pos__ = 0;
        size_t u_limit_1__ = 2;
