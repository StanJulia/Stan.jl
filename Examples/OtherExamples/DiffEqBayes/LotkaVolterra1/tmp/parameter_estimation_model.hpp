...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(35, 35, "end", "/Users/rob/.julia/v0.6/Stan/Examples/OtherExamples/DiffEqBayes/LotkaVolterra1/tmp/parameter_estimation_model.stan");
    return reader;
}
...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        for (int i0__ = 0U; i0__ < 2; ++i0__)
            try {
            writer__.scalar_lub_unconstrain(0.10000000000000001,3.0,params[i0__]);
        } catch (const std::exception& e) { 
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (size_t k_0__ = 0; k_0__ < dim_params_0__; ++k_0__) {
                if (jacobian__)
                    params.push_back(in__.scalar_lub_constrain(0.10000000000000001,3.0,lp__));
                else
                    params.push_back(in__.scalar_lub_constrain(0.10000000000000001,3.0));
            }
