...
internal_var___du[1] = theta[1] * internal_var___u[1] - theta[2] * internal_var___u[1] * internal_var___u[2];
 # /Users/rob/.julia/v0.6/Stan/Examples/OtherExamples/DiffEqBayes/LotkaVolterra2/LotkaVolterra2.jl, line 10:;
internal_var___du[2] = -theta[3] * internal_var___u[2] + theta[4] * internal_var___u[1] * internal_var___u[2];
  ...
  model{
    ...
    theta[1] ~normal(1.5, 1.0) T[0.0,2.0];theta[2] ~normal(1.0, 1.0) T[0.0,2.0];theta[3] ~normal(3.0, 1.0);theta[4] ~normal(1.0, 1.0) T[0.0,2.0];;
