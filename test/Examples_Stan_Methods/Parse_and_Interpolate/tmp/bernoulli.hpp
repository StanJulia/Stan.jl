...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/Users/rob/.julia/dev/Stan/test/Examples_Stan_Methods/Parse_and_Interpolate/tmp/bernoulli.stan");
    reader.add_event(31, 29, "end", "/Users/rob/.julia/dev/Stan/test/Examples_Stan_Methods/Parse_and_Interpolate/tmp/bernoulli.stan");
    return reader;
}

double
my_function(std::ostream* pstream__) {
...
struct my_function_functor__ {
            double
    operator()(std::ostream* pstream__) const {
        return my_function(pstream__);
    }
};

void
model_specific_function(std::ostream* pstream__) {
    typedef double local_scalar_t__;
    typedef local_scalar_t__ fun_return_scalar_t__;
    const static bool propto__ = true;
    (void) propto__;
...
struct model_specific_function_functor__ {
            void
    operator()(std::ostream* pstream__) const {
        return model_specific_function(pstream__);
    }
};

class bernoulli_model
  : public stan::model::model_base_crtp<bernoulli_model> {
private:
        int N;
        std::vector<int> y;
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            model_specific_function(pstream__);
            current_statement_begin__ = 27;
            lp_accum__.add(beta_log<propto__>(theta, my_function(pstream__), 1));
