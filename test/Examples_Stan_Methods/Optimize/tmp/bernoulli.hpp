...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/Users/rob/.julia/dev/Stan/test/Examples_Stan_Methods/Optimize/tmp/bernoulli.stan");
    reader.add_event(13, 11, "end", "/Users/rob/.julia/dev/Stan/test/Examples_Stan_Methods/Optimize/tmp/bernoulli.stan");
    return reader;
}
