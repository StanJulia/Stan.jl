...
@time bayesian_result = stan_inference(prob1,t,data,priors;num_samples=1000, nchains=1,
...
@time bayesian_result = stan_inference(prob1,t,data,priors, stanmodel;
  num_samples=500, nchains=1,
  num_warmup=500,vars =(StanODEData(),InverseGamma(3,3)))
